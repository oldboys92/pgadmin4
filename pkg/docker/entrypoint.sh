...
if [ -n "${GUNICORN_ACCESS_LOGFORMAT}" ]; then
  GUNI_ACCESS_LOGFORMAT="--access-logformat ${GUNICORN_ACCESS_LOGFORMAT}"
else
  GUNI_ACCESS_LOGFORMAT=""
fi
